...
// Maps our internal standard keys to the exact payment_mode strings each
// provider's backend expects. Add new providers here without touching handlers.
const PROVIDER_METHOD_MAPPING = {
  PhonePe: {
    CARD: "CARD",
...
export default function CheckoutPage() {
  ...
  const handleCardPay = (e) => {
    ...
    submitPayment({
      access_key: accessKey,
      payment_mode: PROVIDER_METHOD_MAPPING[activeProvider].CARD,
